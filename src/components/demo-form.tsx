          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-6 mb-8 text-left">
            ...
            <div className="space-y-3">
              {[
                ...
                { step: '3', text: 'Upload your first DMARC report during the demo ΓÇö see real results instantly' },
              ].map((item) => (
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-slate-950 relative overflow-hidden items-center justify-center p-12">
        ...
        <div className="relative max-w-md">
          ...
          <h2 className="text-3xl font-bold text-white mb-4">
            See what&apos;s happening to your emails ΓÇö before revenue is lost
          </h2>
          ...
          <div className="space-y-5 mb-10">
            {[
              ...
              { icon: Zap, text: 'Actionable fixes ΓÇö not just raw data' },
            ].map((item) => (
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 leading-relaxed">
                  ...
                  No generic slide decks ΓÇö just your data, your insights.
                </p>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                {/* INMYBOX ENHANCEMENT: L7 ΓÇö phone field purpose disclosure */}
                <p className="text-xs text-slate-400 mt-1">Optional ΓÇö used only to schedule your demo call</p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  rows={3}
                  placeholder="We're struggling with inbox placement on our marketing campaignsΓÇª"
