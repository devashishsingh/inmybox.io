          ...
          <div className="bg-white/[0.04] rounded-2xl border border-white/10 p-6 mb-8 text-left">
            ...
            <div className="space-y-3">
              {[
                ...
                { step: '3', text: 'Upload your first DMARC report during the demo G현 see real results instantly' },
              ].map((item) => (
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-transparent relative overflow-hidden items-center justify-center p-12">
        ...
        <div className="relative max-w-md">
          ...
          <h2 className="text-3xl font-bold text-white mb-4">
            See what&apos;s happening to your emails G현 before revenue is lost
          </h2>
          ...
          <div className="space-y-5 mb-10">
            {[
              ...
              { icon: Zap, text: 'Actionable fixes G현 not just raw data' },
            ].map((item) => (
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-zinc-500 leading-relaxed">
                  ...
                  No generic slide decks G현 just your data, your insights.
                </p>
              </div>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                {/* INMYBOX ENHANCEMENT: L7 G현 phone field purpose disclosure */}
                <p className="text-xs text-zinc-500 mt-1">Optional G현 used only to schedule your demo call</p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  rows={3}
                  placeholder="We're struggling with inbox placement on our marketing campaignsG푸"
