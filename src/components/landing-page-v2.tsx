...
function FooterV2() {
  return (
    <footer className="relative z-10 border-t border-white/[0.06] pt-20 pb-10 overflow-hidden">
      ...
      {/* Watermark */}
      <div className="ember-watermark mb-10 -mx-10">INMYBOX</div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 border-t border-white/[0.06] flex flex-wrap justify-between items-center gap-4">
        ...
        <div className="flex gap-5 text-[10px] uppercase tracking-[0.2em] text-zinc-600">
          <a href="#" className="hover:text-zinc-300">Twitter</a>
          <a href="#" className="hover:text-zinc-300">LinkedIn</a>
          <a href="mailto:hello@inmybox.io" className="hover:text-zinc-300">Email</a>
        </div>
      </div>
    </footer>
  )
