    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="mb-16">
          ...
          {/* Download section */}
          <div className="mt-8 p-5 bg-zinc-900/60 border border-zinc-700/50 rounded-xl">
            <p className="text-sm font-semibold text-white mb-1">Download documents</p>
            <p className="text-xs text-zinc-500 mb-4">PDF versions generated fresh on demand — share with your team or DNS administrator.</p>
            <div className="flex flex-wrap gap-3">
              <a
                href="/api/docs/onboarding-guide"
                download
              ...
              <a
                href="/api/docs/app-workflow"
                download
                className="inline-flex items-center gap-2 px-4 py-2 bg-zinc-700 hover:bg-zinc-600 text-white text-sm font-semibold rounded-lg transition-colors"
              >
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                </svg>
                Application Workflow (PDF)
              </a>
            </div>
          </div>
        </div>
