...
export const metadata: Metadata = {
  title: 'Setup Guide',
  description: 'Step-by-step setup guide for connecting your domain to Inmybox.',
}
      ...
      <div className="min-h-screen">
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
          ...
          <p className="text-zinc-400 leading-relaxed max-w-xl mx-auto mb-8">
            This page is being prepared. Our team will walk you through DMARC record configuration
            and report routing during your onboarding. Contact us for a personalized setup plan.
          </p>
